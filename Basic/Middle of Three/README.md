<h2><a href="https://www.geeksforgeeks.org/problems/middle-of-three2926/1?page=4&difficulty=School,Basic&sortBy=submissions">Middle of Three</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given three distinct numbers&nbsp;A, B and C. Find the number with value in middle (Try to do it with minimum comparisons).</span></p>
