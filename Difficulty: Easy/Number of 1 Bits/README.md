<h2><a href="https://www.geeksforgeeks.org/problems/set-bits0143/1?page=5&difficulty=School,Easy&sortBy=submissions">Number of 1 Bits</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a positive integer N, print count of set bits in it.&nbsp;</span></p>
